...
def transfer_initial_param_cnn(params):
    ...
    model_wrapper = TransferVGGFixLayersNet(**params)
    ...
    out_df.to_csv(os.path.dirname(__file__) + '/submission_transfer_vgg.csv', index=False)


if __name__ == "__main__":
    transfer_initial_param_cnn(params={'epochs': 10, 'gamma': 0.5, 'lr': 0.001, 'mini_batch': 64})